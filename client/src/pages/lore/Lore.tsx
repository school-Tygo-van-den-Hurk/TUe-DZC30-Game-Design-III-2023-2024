    ...
    return (
        <>
            ...
            <p>
                ...
                each other to become the best treasure hunting campus in the whole world. 
            </p>
            <figure className="image-container" >
                <img src="/pirate-captain.jpeg" alt="a pirate wearing a hat" />
                <figcaption> Captain Gabriele Ferri </figcaption>
            </figure>
            <p>
                The map to Captain Gabriele Ferri's treasure is of 
